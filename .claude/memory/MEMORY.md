...
- [Canonical identity invariant](project_canonical_identity_invariant.md) — da#356/PR#363; id+name = f(MENTION), never the bio. **crossref (Stage 5), not fuzzy, = 92% of 14,316 chimeras** (no lev bound, skipped BOTH filters). "mention must be bio-registered" is VACUOUS (0/742,607 — Stage 1 early-returns). De-keying is 89.4% correct separation, not fragmentation. da#248 carve-out is load-bearing.
