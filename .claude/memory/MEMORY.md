...
- [structural-ontology gate commit friction](feedback_structural_gate_commit_friction.md) — regen index w/ python3 NOT uv run (line-number drift); untracked .claude/worktrees breaks pre-commit stash. #723. Local hook SKIPS when only tests/ change; CI staleness-check does NOT — regen after adding test methods.
